			...
			<?php foreach ($tipos AS $tipo): ?>
				<tr>
					...
					<td  class="actions">
						...
						<a href="#">
							<img class="del del_category" id="<?php echo $tipo['id_tipodocumentos']; ?>" src="<?php echo ASSETS . 'frontend/images/icons/del_30.png'; ?>" alt="eliminar" title="Borrar" width="20" height="20" />
						</a>
					</td>
				</tr>
			<?php endforeach ?>
